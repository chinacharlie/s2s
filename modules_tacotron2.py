...
from hyperparams_tacotron2 import Hyperparams as hp
...
#from tensorflow.contrib.rnn_cell.python.ops.core_rnn_cell_impl import LSTMStateTuple

#from tf.contrib.rnn_cell_impl import *
...
def bidirectional_LSTM(inputs, scope, training):
  ...
  with tf.variable_scope(scope):
    ...
    #final_state = rnn_cell_impl.LSTMStateTuple( c=encoder_final_state_c, h=encoder_final_state_h)

  return tf.concat(outputs, axis=2), 0 #final_state # Concat forward + backward outputs and final states
