...
import math
from hyperparams import Hyperparams as Hpbase
...
class Hyperparams:
    ...
    dec_postnet_size = 5
    dec_postnet_filters = 256
    dec_projection = 256
    
    ## Converter
    converter_layers = 4
    converter_filter_size = 5
    converter_channels = 64
	
    # data
    max_duration = Hpbase.duration#10.10 # seconds
